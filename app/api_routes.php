 ...
 * V2版本接口路由
 * */
Route::get('ucenter_v2/index','api_v2/v2.UserCenter/index');
Route::get('ucenter_v2/consumerlist','api_v2/v2.Order/consumerList');
Route::get('ucenter_v2/customerlist','api_v2/v2.Order/customerList');
Route::get('ucenter_v2/customers','api_v2/v2.UserCenter/customers');
Route::get('order_v2/statistics','api_v2/v2.Order/statistics');
Route::get('ucenter_v2/visit','api_v2/v2.UserCenter/visit');
Route::get('ucenter_v2/stockout','api_v2/v2.Order/stockOut');
Route::get('publics_v2/brand','api_v2/v2.Common/brand');
Route::get('publics_v2/series','api_v2/v2.Common/series');
Route::get('publics_v2/carlist','api_v2/v2.Common/carList');
Route::post('publics_v2/upload','api_v2/v2.Common/upload');
Route::get('publics_v2/gettoken','api_v2/v2.Common/getToken');
Route::post('ucenter_v2/quotation','api_v2/v2.UserCenter/quotation');
Route::get('ucenter_v2/quotationDetail','api_v2/v2.Common/quotationDetail');
Route::get('publics_v2/share','api_v2/v2.Common/share');
Route::get('publics_v2/contract','api_v2/v2.Common/contract');
Route::get('publics_v2/createImage','api_v2/v2.Common/createImage');
Route::get('ucenter_v2/consumerDetail','api_v2/v2.Common/consumerDetail');
Route::get('ucenter_v2/stocklist','api_v2/v2.Order/stockList');
Route::get('ucenter_v2/stockcarlist','api_v2/v2.Order/stockCarList');
Route::get('ucenter_v2/organizationlist','api_v2/v2.Organization/index');
Route::post('ucenter_v2/organization/create','api_v2/v2.Organization/create');
Route::post('ucenter_v2/organization/edit','api_v2/v2.Organization/edit');
Route::get('ucenter_v2/logistics','api_v2/v2.Logistics/index');
Route::get('ucenter_v2/logistics/consignment','api_v2/v2.Logistics/consignment');
Route::get('ucenter_v2/shop','api_v2/v2.Shop/index');
Route::get('ucenter_v2/shop/activity','api_v2/v2.Shop/activity');
Route::get('ucenter_v2/userlist','api_v2/v2.UserCenter/userList');
Route::get('ucenter_v2/userdetail','api_v2/v2.UserCenter/userDetail');
Route::get('ucenter_v2/getseller','api_v2/v2.UserCenter/getSeller');
Route::get('ucenter_v2/supplier','api_v2/v2.Supplier/index');
Route::get('ucenter_v2/carsproductlist','api_v2/v2.Order/carsProductList');
Route::get('ucenter_v2/carsproductlist','api_v2/v2.Order/carsProductList');
Route::post('login_v2/index','api_v2/v2.Login/index');
...
//前台店铺垫资接口
Route::post('shop_v2/loan/index','api_v2/v2.Shop.Loan/index');
Route::get('shop_v2/user/profile','api_v2/v2.Shop.User/profile');
Route::post('shop_v2/Index/verify','api_v2/v2.Shop.Index/verify');

//后台接口
//后台文章管理
Route::get('backend_v2/article/index','api_v2/v2.Backend.Article/index');
Route::post('backend_v2/article/create','api_v2/v2.Backend.Article/create');
Route::post('backend_v2/article/edit','api_v2/v2.Backend.Article/edit');
Route::get('backend_v2/article/detail','api_v2/v2.Backend.Article/detail');
Route::get('backend_v2/article/remove','api_v2/v2.Backend.Article/remove');
Route::get('backend_v2/article/publish','api_v2/v2.Backend.Article/publish');

//后台库存管理
Route::get('backend_v2/stock','api_v2/v2.Backend.StockCar/index');
Route::post('backend_v2/stock/edit','api_v2/v2.Backend.StockCar/edit');
Route::get('backend_v2/stock/detail','api_v2/v2.Backend.StockCar/detail');
Route::get('backend_v2/stock/export','api_v2/v2.Backend.StockCar/export');
Route::get('backend_v2/consumer/export','api_v2/v2.Backend.ConsumerOrder/export');
Route::get('backend_v2/consumer/index','api_v2/v2.Backend.ConsumerOrder/index');
Route::get('backend_v2/consumer/detail','api_v2/v2.Backend.ConsumerOrder/consumerDetail');
Route::get('backend_v2/supplier','api_v2/v2.Backend.Supplier/index');
Route::post('backend_v2/supplier/create','api_v2/v2.Backend.Supplier/create');
Route::post('backend_v2/supplier/remove','api_v2/v2.Backend.Supplier/remove');
Route::get('backend_v2/car','api_v2/v2.Backend.Car/index');
Route::get('backend_v2/car/family','api_v2/v2.Backend.Car/family');

//后台角色管理
Route::get('backend_v2/role/index','api_v2/v2.Backend.Role/index');
Route::post('backend_v2/role/create','api_v2/v2.Backend.Role/create');
Route::post('backend_v2/role/edit','api_v2/v2.Backend.Role/edit');
Route::get('backend_v2/role/remove','api_v2/v2.Backend.Role/remove');
Route::get('backend_v2/roleaccess/index','api_v2/v2.Backend.RoleAccess/index');
Route::post('backend_v2/roleaccess/addauth','api_v2/v2.Backend.RoleAccess/addAuth');
Route::get('backend_v2/systemuser/index','api_v2/v2.Backend.SystemUser/index');
Route::post('backend_v2/systemuser/create','api_v2/v2.Backend.SystemUser/create');
Route::post('backend_v2/systemuser/edit','api_v2/v2.Backend.SystemUser/edit');
Route::get('backend_v2/systemuser/detail','api_v2/v2.Backend.SystemUser/detail');
Route::get('backend_v2/role/list','api_v2/v2.Backend.Role/lists');
Route::get('backend_v2/systemuser/higherups','api_v2/v2.Backend.SystemUser/higherUps');
Route::get('backend_v2/systemuser/remove','api_v2/v2.Backend.SystemUser/remove');

//组织机构
Route::get('backend_v2/organization/index','api_v2/v2.Backend.Organization/index');
Route::post('backend_v2/organization/create','api_v2/v2.Backend.Organization/create');
Route::post('backend_v2/organization/edit','api_v2/v2.Backend.Organization/edit');
Route::get('backend_v2/organization/detail','api_v2/v2.Backend.Organization/detail');
Route::get('backend_v2/organization/remove','api_v2/v2.Backend.Organization/remove');
Route::get('backend_v2/organization/getorg','api_v2/v2.Backend.Organization/getOrg');

Route::get('backend_v2/menu/index','api_v2/v2.Backend.Menu/index');
Route::post('backend_v2/menu/create','api_v2/v2.Backend.Menu/create');
Route::post('backend_v2/menu/edit','api_v2/v2.Backend.Menu/edit');
Route::get('backend_v2/menu/remove','api_v2/v2.Backend.Menu/remove');
Route::post('backend_v2/login','api_v2/v2.Backend.Login/index');
Route::get('backend_v2/brand','api_v2/v2.Backend.Publics/brand');
Route::get('backend_v2/customer','api_v2/v2.Backend.CustomerOrder/index');
Route::get('backend_v2/customer/detail','api_v2/v2.Backend.CustomerOrder/detail');
Route::get('backend_v2/systemuser/info','api_v2/v2.Backend.SystemUser/userInfo');
Route::post('backend_v2/customer/pay','api_v2/v2.Backend.CustomerOrder/pay');
Route::get('backend_v2/consumer/getpayinfo','api_v2/v2.Backend.ConsumerOrder/getPayInfo');
Route::post('backend_v2/consumer/pay','api_v2/v2.Backend.ConsumerOrder/pay');
Route::get('backend_v2/stocklist','api_v2/v2.Backend.Stock/index');
Route::post('backend_v2/editstock','api_v2/v2.Backend.Stock/edit');
Route::post('backend_v2/createstock','api_v2/v2.Backend.Stock/create');
Route::get('backend_v2/removestock','api_v2/v2.Backend.Stock/remove');

//验证JAVA接口权限
Route::get('backend_v2/publics/checkauth','api_v2/v2.Backend.Publics/checkJavaApiAuth');
Route::get('ucenter_v2/export/test','api_v2/v2.Export/test');


//官网
Route::get('pc_v2/news','api_v2/v2.PC.News/index');
Route::get('pc_v2/news/detail','api_v2/v2.PC.News/detail');
Route::post('pc_v2/note','api_v2/v2.PC.News/note');
Route::get('backend_v2/note','api_v2/v2.Backend.Note/index');
Route::get('pc_v2/organization','api_v2/v2.PC.News/organization');