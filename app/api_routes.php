...
Route::post('ucenter_v2/consumer/update','api/v2.Order/consumerUpdate');
...
Route::get('upload_v2/upImage','api/v2.Upload/upImage');
Route::get('upload_v2/index','api/v2.Upload/index');
Route::get('upload_v2/excelImport','api/v2.Upload/excelImport');
Route::post('upload_v2/uploadFile','api/v2.Upload/uploadHandle');
Route::post('upload_v2/uploadExcel','api/v2.Upload/uploadExcel');
Route::get('upload_v2/makeZip','api/v2.Upload/makeZip');