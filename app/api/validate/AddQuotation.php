...
class AddQuotation extends Validate{
    ...
    protected $rule = [
        ...
        'purchase_tax'            => 'checkFee',
        'license_plate_priace'    => 'checkFee',
        'vehicle_vessel_tax'      => 'checkFee',
        'mortgage'                => 'checkFee',
        'insurance_price'         => 'checkFee',
        'traffic_insurance_price' => 'checkFee',
        'boutique_priace'         => 'checkFee',
        'quality_assurance'       => 'checkFee',
        'other'                  => 'checkFee',
