<?php
namespace app\api_v2\service;

use think\Model;

class ImagickService extends Model {
...
//    }
    ...
    /*
     * 添加一个边框 $width: 左右边框宽度 $height: 上下边框宽度 $color: 颜色: RGB 颜色 'rgb(255,0,0)'
     * 或 16进制颜色 '#FF0000' 或颜色单词 'white'/'red'...
     */
